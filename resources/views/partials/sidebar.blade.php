<div class="col-md-4 col-xl-3 bg-pale-info" style="height: auto !important;">
    <div class="sidebar px-4 py-md-0">

        <h6 class="sidebar-title mt-2">Search</h6>
        <form class="input-group" action="" method="GET">
            <input type="text" class="form-control" name="search" placeholder="Search" value="{{ request('search') }}">
            <div class="input-group-addon">
                <span class="input-group-text"><button type="submit"><i class="ti-search"></i></button></span>
            </div>
        </form>
